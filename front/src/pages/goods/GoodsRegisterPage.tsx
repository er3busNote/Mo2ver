	...
	if (componentType === 'Update') {
		...
		if (goodsInfo && goodsInfo.goodsCode && !isDataLoaded) {
			...
			reset({
				...
				summaryInfo: goodsInfo.summaryInfo,
				goodsImg: goodsInfo.goodsimageList,
				largeCategory: goodsInfo.largeCategoryCode,
				mediumCategory: goodsInfo.mediumCategoryCode,
				smallCategory: goodsInfo.smallCategoryCode,
				buyLimitYesNo: goodsInfo.buyLimitYesNo,
				salePeriodYesNo: goodsInfo.salePeriodYesNo,
				saleStartDate: dayjs(goodsInfo.saleStartDate),
				saleEndDate: dayjs(goodsInfo.saleEndDate),
				supplyPrice: goodsInfo.supplyPrice,
				salePrice: goodsInfo.salePrice,
				maxBuyQuantity: goodsInfo.maxBuyQuantity,
				discountPrice: goodsInfo.discountPrice,
				discountStartDate: dayjs(goodsInfo.discountStartDate),
				discountEndDate: dayjs(goodsInfo.discountEndDate),
			});
