...
const GoodsRow: FC = (): JSX.Element => {
	...
	return (
		<Box>
			<Box sx={rowItem}>
				<Box sx={cardBox}>
					<Card elevation={0} onClick={() => goodsClick('스파오', '0')}>
						<CardActionArea>
							<CardMedia
								component="img"
								image={IMAGE_INFO[0]}
			...
			<Box sx={rowItem}>
				<Box sx={cardBox}>
					<Card elevation={0} onClick={() => goodsClick('코드그라피', '1')}>
						<CardActionArea>
							<CardMedia
								component="img"
								image={IMAGE_INFO[1]}
			...
			<Box sx={rowItem}>
				<Box sx={cardBox}>
					<Card elevation={0} onClick={() => goodsClick('집시', '2')}>
						<CardActionArea>
							<CardMedia
								component="img"
								image={IMAGE_INFO[2]}
			...
			<Box sx={rowItem}>
				<Box sx={cardBox}>
					<Card elevation={0} onClick={() => goodsClick('키뮤어', '3')}>
						<CardActionArea>
							<CardMedia
								component="img"
								image={IMAGE_INFO[3]}
