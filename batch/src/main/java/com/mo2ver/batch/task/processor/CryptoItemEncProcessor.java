...
public class CryptoItemEncProcessor implements ItemProcessor<DataDto, File> {
    ...
    public File process(DataDto item) throws Exception {
        return getInputOriginPath(item.getId());
    }

    private static File getInputOriginPath(String targetId) {
